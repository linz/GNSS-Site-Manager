...
import { mockHumiditySensor } from './view-model';

describe('Humidity Sensor Group Component', () => {

    let siteId: string = 'ADE1';
    let viewModel: HumiditySensorViewModel = mockHumiditySensor;
    ...
    beforeAll(() => {
        ...
        itemGroup = siteLogPage.humiditySensorGroup;
    ...
    it('expect should be able to add and save a new item', () => {
        ...
        itemGroup.accuracyPercentRelativeHumidityInput.sendKeys(viewModel.accuracyPercentRelativeHumidity.toString());
    ...
    it('expect should have all input values for the new item created previously', () => {
        ...
        itemGroup.itemGroupHeader.click().then(() => {
            ...
            TestUtils.checkInputValueEqual(itemGroup.accuracyPercentRelativeHumidityInput,
                                                        'Accuracy HPa', viewModel.accuracyPercentRelativeHumidity);
