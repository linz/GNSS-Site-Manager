...
export class SiteLocationViewModel extends AbstractViewModel {
    ...
    public cartesianPosition_x: number = null;
    public cartesianPosition_y: number = null;
    public cartesianPosition_z: number = null;
    public geodeticPosition_lat: number = null;
    public geodeticPosition_long: number = null;
    public geodeticPosition_height: number = null;
