...
<wfs:FeatureCollection xmlns:wfs="http://www.opengis.net/wfs/2.0" 
    ...
    xsi:schemaLocation="http://www.opengis.net/wfs/2.0 
        ...
        urn:xml-gov-au:icsm:egeodesy:0.3 
    ...
    <wfs:member>
        <geo:Site gml:id="Site.14252">
            <gml:identifier codeSpace="urn:xml-gov-au:icsm:egeodesy:0.3:SiteIdentifier">ADE1</gml:identifier>
            <gml:name codeSpace="urn:xml-gov-au:icsm:egeodesy:0.3:SiteName">Australia NGA collocated</gml:name>
            <geo:type codeSpace="urn:xml-gov-au:icsm:egeodesy:0.3:SiteType">CORS</geo:type>
        </geo:Site>
    </wfs:member>
